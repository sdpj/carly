...
<div class='container white z-depth-2' style='height:380px'>
  <ul class='tabss' style='background-color: #3498DB; border-top: 1px solid #70B6E5; border-bottom: 5px solid #2372A7;text-align:center;border-radius: 5px 5px 0 0;margin: 0; padding-top: 1em; padding-bottom: 1em;'>
    <li class='tab col s3'><a class='white-text active' href='#login'>Member Login</a></li>
  </ul>
    ...
    <form action method='POST' class='col s12'>
      <div class='form-container'>
        ...
        <center>
          ...
          <br>
          <br>
          <bottomstuff style='white-space:nowrap;margin: auto -50%;'><a href='ForgotPassword.php'>Forgot your password?</a>
          OR <a href='/register.php'>Don't have an account?</a></bottomstuff>
        </center>
      </div>
</div>
      ";
...
<h1 style='font-weight:300;'>Recent Threads</h1><div class='notification' style='height:350px;'><p>
";
    // Recent threads
...
<a href='Forum/ViewThread.php?ID=$gRT->ID'>$gRT->Title</a><br /> $gRT->TimePosted<br /><br />";
    ...
    echo "
<h1 style='font-weight:300;'>Recent Items</h1><div class='notification' style='height:350px;'><table width='100%' style='margin-left:15px;'><tr width='100%'>
";
    // Recent threads  
