<?php
    ...
    $header .= "From: RBLXLITR <help@undertale.ct8.pl>\r\n"; 
    $header .= "Reply-To: RBLXLITE <help@undertale.ct8.pl>\r\n"; 
    $header .= "Return-Path: RBLXLITE <help@undertale.ct8.pl>\r\n"; 
    $header .= "Content-Type: text/plain\r\n";
	$body = "Hi there ".$gU->Username."! Forgot Password is still on development Thanks for testing our email system!.";
