...
<style>.thesex { background: #7474bf;
...
<div class="light-blue lighten-1 thesex" style="color:white;padding:15px 25px;background: #600e74; background: linear-gradient( 90deg ,#600e74,#fe00b0); border: 0;">
...
<center></br><a href="reply.php?id=<? echo $id ?>" class="finoob" style="display:block; width:150px;">Reply</a></br>
<? include "../../footer.php"; ?>