...
<?php
$con = mysql_pconnect("localhost", "u573660077_admin", "OneilIs11") or die("Something went wrong while connecting to the database - ID: 1");
mysql_select_db("u573660077_db", $con) or die("Something went wrong while connecting to the database - ID: 2");
$logged = false;
