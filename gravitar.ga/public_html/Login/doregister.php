    ...
    if (!ctype_alnum($username)){
      ...
      include('../global.php');
        die("That email already exists. Please press back, or click <a href='Register.php'>here</a>");
            ...
            mysql_query("INSERT INTO `accounts` (`Username`, `Password`, `Name`, `Email`, `ShirtPath`, `PantsPath`, `EyesPath`, `HairPath`, `MouthPath`, `blurb`, `statusupdate`) VALUES ('$username', '$hashed', '$name', '$email', 'Default Shirt.png', 'Default Pants.png', 'Default Eyes.png', 'Default Hat.png', 'Default Smile.png', 'It appears this user has no blurb. You can change yours in the settings!', 'I&#39;m new to Gravitar!')");
