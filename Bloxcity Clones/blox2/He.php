    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="color: #d9534f;">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/" style="color: white;">AvatarBlocks</a>
            </div>
...
<li>
                    ...
                    <li>
                        <a href="/Users.php" </span>&nbsp;&nbsp;Users</a>
                    </li>
<?
$getConfig = mysql_query("SELECT * FROM Configuration");
$gC = mysql_fetch_object($getConfig);
if($gC->Avatars == "3D"){
echo"<li><a href='/Store/UserStore.php' </span>&nbsp;&nbsp;Store</a></li>";}elseif($gC->Avatars == "2D"){
echo"        <li>
                        <a href='/UserShop/' </span>&nbsp;&nbsp;User Store</a>
                    </li>";
};
?>
                </ul>
...
<li><a href='#' style='color: lightgreen;'>$Bux Cash</a></li>
          ...
          <ul class='dropdown-menu' role='menu'  style='color: #d9534f;'>
            <li style='color: #d9534f;'><a href='Settings.php' </span>&nbsp;&nbsp;Account Settings</a></li>
            <li><a href='Character.php' </span>&nbsp;&nbsp;Wardrobe</a></li>";
            if($myU->PowerAdmin == "true"){
            echo"<li class='divider'></li>
            <li><a href='Admin.php'  </span>&nbsp;&nbsp;Admin Panel</a></li>
            <li><a href='ItemModeration.php'  </span>&nbsp;&nbsp;User Shop Mod</a></li>";
            };
            echo"<li class='divider'></li>
