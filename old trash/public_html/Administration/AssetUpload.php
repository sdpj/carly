<?php
include "Header.php";
if($User) { if($myU->PowerArtist == "false") { header("Location: ../index.php"); exit(); }  else { ?>
<table width='100%'>
	<tr>
		<td width='75%' valign='top'>
			
			<font size='4'>Asset Uploading</font><br /><br />
...
mysql_query("INSERT INTO Logs (UserID, Message, Page) VALUES('".$myU->ID."','uploaded ".$itemname."','".$_SERVER['PHP_SELF']."')");
 ...
 echo "</td><td width='25%' valign='top'>Template</div><div id='aB'><center><img src='/Dir/Avatar.png'></div></td></tr></table>";
 }
 }
