 <?
  ...
  if ($Exist == "0"){
    ...
    if($gI->PremiumOnly == "1"){
      $PremStat = "<center>This item is listed as a <a href='/Upgrades/premium.aspx' style='font-size:13px;'>membership</a> only item.
            <br />
            Only <a href='/Upgrades/premium.aspx' style='font-size:13px;'>membership</a> users can purchase this item.
            </center>".$time."";
    }else{
            ...
            <center><table cellspacing='0' cellpadding='0' style='width:100%;'>
              <tr>
                <td style='width:33%;text-align:center;'>
                  <a href='http://avatar-gamer.ga/user.aspx?ID=".$gS->ID."'>
                    <div align='center'><div style='height:100px;width:100px;overflow-y:hidden;'>
                      <img src='http://avatar-gamer.ga/Avatar.aspx?ID=".$gS->ID."'>
                    </div></div>
                    ".$gS->Username."
                  </a>
                </td>
                <td style='width:33%;text-align:center;'>
                  ...
                  <br />
                  <img src='http://avatar-gamer.ga/Store/Dir/".$gI->File."' height='100' width='50'>
                </td>
                <td style='width:33%;text-align:center;'>
            ...
            if($num_row == 0){
              ...
              die();
               ...
               if ($num_row == 1 && $myU->Bux >= $SalePrice && $row->UserID != $myU->ID){
                ...
                header("Location: http://avatar-gamer.ga/character.aspx");
                die();
              }else{
                $getpastowner = mysql_query("SELECT * FROM Users WHERE ID='".$row->UserID."'");
                $gpo = mysql_fetch_object($getpastowner);
            ...
            <table cellspacing='0' cellpadding='0' style='width:100%;'>
              <tr>
                <td style='text-align:center;'>
                  <a href='http://avatar-gamer.ga/user.aspx?ID=<?echo"".$myU->ID."";?>'>
                    <div align='center'><div style='height:100px;width:100px;overflow-y:hidden;'>
                      <img src='http://avatar-gamer.ga/Avatar.aspx?ID=<?echo"".$myU->ID."";?>'>
                    </div></div>
                    <?echo"".$myU->Username."";?>
                  </a>
                </td>
                  ...
                  <tr>
                    <td style='text-align:center;'>
                      <a href='http://avatar-gamer.ga/user.aspx?ID=".$gP->ID."'>
                        <div align='center'><div style='height:100px;width:100px;overflow-y:hidden;'>
                          <img src='http://avatar-gamer.ga/Avatar.aspx?ID=".$gP->ID."'>
                        </div></div>
                        ".$gP->Username."
                      </a>
                    </td>
          ...
          <div class='GenericModalBody'>
            <div class='TopBody' style='padding:10px;text-align:center;'>
              <div class='Message'>
                ...
                <img src='http://avatar-gamer.ga/Images/Oops.png' height='64'>
              </div>
            </div>
            <div class='ConfirmationContainer'>
              <center>
                <a href='http://avatar-gamer.ga/Store/Item.aspx?ID=".$ID."?#CommentSection' class='btn-forgotten'>Cancel</a>
              </center>
            </div>
          </div>   
        </div>
    ...
    if($gI->PremiumOnly > 0&&$myU->Premium == 0){
      ...
      if ($gI->saletype == "limited"&&$gI->numberstock == "0") {
        ...
        <div class='BoxContainer'>
          <div tabindex='-1' style='height: 100%; outline: 0px; width: 100%; overflow: visible;'>
            ...
            <div class='GenericModalBody'>
              ...
              <div class='ConfirmationContainer'>
                <center>
                  <a href='http://avatar-gamer.ga/Store/Item.aspx?ID=".$ID."' class='btn-forgotten'>Cancel</a>
                </center>
              </div>
            </div>   
          </div>
        ...
        if ($tG >= 1){
          ...
          header("Location: http://avatar-gamer.ga/Store/Item.aspx?ID=".$ID."");
          die();
        }
      }
    }else {
