...
<meta name="description" content="<?php echo config::getName();?>! Socialize with friends, play games and customize your character. Create an account for free and explore the older versions of an amazing game without giving some Russian access to your PC!">
<meta name="keywords" content="Old Roblox, <?php echo config::getName();?>, XDiscuss, Socialize, Games, Forum, Character customisation, Rhodum, FinalB">
<meta name="author" content="<?php echo config::getName();?>">
<script>
