...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" xmlns:fb="http://www.facebook.com/2008/fbml">
   ...
   <body class="">
      <div id="MasterContainer">
         ...
         <?php if(!isset($_SESSION['id'])){ header('Location: Landing.aspx'); die(); } ?>
    ...
    <?php if(!isset($_SESSION['id']) && !isset($_GET['lang'])){ header('Location: Landing.aspx'); die(); } ?>
         <?php if(!isset($_SESSION['id']) && isset($_GET['lang'])){ header('Location: Landing?lang=ru'); die(); } ?>
