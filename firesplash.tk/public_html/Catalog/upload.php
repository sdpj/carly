				...
				echo"
					<center>
						<div style='height:115px;'></div> <!-- SPACE -->
							...
							<h1>Upload a pair of shirts or pants!</h1><br>
							<h4 style='color:grey;'>Here are some rules to follow before uploading!</h4><br>
							<div style='display:flex;padding-left:5%;'>
								<div style='margin-right:3%;'><i class='fa fa-square' style='color:#19ff00;'></i> <b>TROU</b> means <b>PANTS.</b> Please select TROU when uploading pants</div>
								<div style='margin-right:3%;'><i class='fa fa-square' style='color:yellow;'></i> If a shirt is bigger or different than the template, <b>it will be declined</b></div>
								<div style='margin-right:3%;'><i class='fa fa-square' style='color:red;'></i> <b>Do not merge</b> shirts and pants into one </div>
							</div>
							<br><br>
								<img src='https://cdn.discordapp.com/attachments/741437971450036236/791684351586205706/UNIPANT.png'></img>
								<img src='https://cdn.discordapp.com/attachments/741437971450036236/791684285543350302/UNITEMPLATE.png'></img>
