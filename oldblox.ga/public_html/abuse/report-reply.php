<?				
	...
	$CheckContent = mysql_query("SELECT * FROM Replies WHERE ID='".$ID."'");
	...
	if($AbuseSubmit){
		if($User){
			if($AbuseCategory != "0"){
				...
				mysql_query("INSERT INTO Reports (UserWhoSent, UserReported, Content, Comment, Category, Type, ItemID) VALUES('$myU->ID','$gO->ID','$BodyReported','$AbuseComment','$AbuseCategory','ForumReply','$ID')");
