...
#navbar2 {
/*height: auto; width: auto; position: absolute; top: 1px; left: -5px; right: auto;*/padding:0px;margin:0px;
}
#navbar2 ul {
  margin: 0px;
  padding: 0px;
...
<?php
if ($logged == true){
  ?><div class="card container mt-3" style="display:block;text-align:center;padding:0px !important;">
<div class="card-body" style="text-align:center;margin:auto;display:block;text-align:center;padding:5px !important;">
<div style="display:block;text-align:center;margin:auto;white-space:nowrap;width: 100%; color: #818181; /*background-color: #240203; z-index: 1; color: white; background:linear-gradient(to bottom, #040404, #313131, #252525);*/">
<ul id="navbar2" style="display:block;text-align:center;">
...
<li><a href="/Account/index.php">Settings</a></li>
