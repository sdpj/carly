...
90deg
 ,#600e74,#fe00b0);
    border: 0;
}</style><nav class="navbar navbar-inverse navbar-fixed-top navbar finalnoob" style="box-shadow:0 1px 2px 0 rgba(34,36,38,.15);<?php echo $addS;?>">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="/games" style="color:#b8d6fe !important;"><i class="fas fa-gamepad" aria-hidden="true"></i> Games</a></li>
        <li><a href="/forum" style="color:#b8d6fe !important;"><i class="fas fa-bullhorn" aria-hidden="true"></i> Forum</a></li>
        <li><a href="/groups" style="color:#b8d6fe !important;"><i class="fas fa-users" aria-hidden="true"></i> Groups</a></li>
        <li><a href="/catalog" style="color:#b8d6fe !important;"><i class="fas fa-store" aria-hidden="true"></i> Catalog</a></li>
        <li><a href="/users" style="color:#b8d6fe !important;"><i class="fas fa-user-friends" aria-hidden="true"></i> Users</a></li>
        <li style="margin:3px 0px 0px;" class="dropdown">
          <a style="margin: -2px 0px 0px;color:#b8d6fe !important;" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">More <span class="caret"></span></a>
          <?php
          ...
          <ul class="dropdown-menu" role="menu" style="<?php echo $addS2;?>">
            ...
            ?>
            <li><a href="/blog"><i class="fas fa-blog" aria-hidden="true"></i> Blog</a></li>
            <li><a href="/ilmuro"><i class="fas fa-biohazard" aria-hidden="true"></i> Стена</a></li>
            <li><a href="/Finobe/Clips"><i class="fas fa-smile-wink" aria-hidden="true"></i> Finobe clips</a></li>
          </ul>
        </li>
      </ul>
...
<?php
  ...
  if ($news_on) {
    ...
    echo '<div class="alert alert-danger center">FinalZ is under maintenance</div>';
  }else{
    echo '<div style="margin-bottom:79px" class="topspace"></div>';
  }
?>
