...
<label for="uploadShirtName">Server IP</label>
</div><h5 style="padding-bottom:20px;">Upload game</h5>
...
<label for="uploadShirtPrice">Port</label>
</div>
<div class="input-field">
...
<br><br><font color='black' style='font-size:10pt;color:red;'>Game are selfhosted.</font></div>
</form>
</div>
</div>
<div class="col s6">
<div class="bc-content" style="font-size:14px;">
<h5 style="padding-bottom:20px;">Game Thumbnail Template</h5>
<a href="/Store/Dir/Game.png" target="_blank" title="Template (Click to Enlarge)" alt="Template (Click to Enlarge)"><img src="/Store/Dir/Game.png" class="responsive-img"></a>
</div>
</div>
</div>
...
if(move_uploaded_file($_FILES['uploaded']['tmp_name'], $target)) 
 ...
 mysql_query("INSERT INTO Games (Name, File, Type, Price, CreatorID, saletype, numbersales, numberstock, CreationTime)
 ...
 echo "Sorry, there was a problem uploading your Game.";
 die();
 }
}
}
