...
bpy.data.textures['$textureName'].image = ".$textureName."TextureChange";
	...
	public function renderAvatar( array $colors = [], array $objNames = [], array $misc = [], array $clothing = [], array $face = []) {
		...
		$python = "import bpy";
		$this->loadMainBlend($python, "blender/vertineer_test2.blend");
		//Clothing
		
		if($clothing['pants'] == false){
			$this->changeTexture($python, "LeftLegTexture", "blender/middle.png");
			$this->changeTexture($python, "RightLegTexture", "blender/middle.png");
		} else {
		...
		if($clothing['shirts'] == false){
			$this->changeTexture($python, "LeftArmTexture", "blender/middle.png");
			$this->changeTexture($python, "RightArmTexture", "blender/middle.png");
			$this->changeTexture($python, "TorsoTexture", "blender/middle.png");
		} else {
	...
	public function renderHat ($objPath, $texturePath, $saveImagePath)
	{
		...
		$python = "import bpy
";
		$this->loadMainBlend($python, "blender/hat.blend");
	...
	public function renderShirt ($id)
	{
		...
		$python = "import bpy
";
		$this->loadMainBlend($python, "blender/shirt_preview.blend");
	...
	public function renderPants ($id)
	{
		...
		$python = "import bpy
";
		$this->loadMainBlend($python, "blender/pant_preview.blend");
	...
	public function renderFace ($id)
	{
		...
		$python = "import bpy
";
		$this->loadMainBlend($python, "blender/face_preview.blend");
