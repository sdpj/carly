<? $title = "Terms of Service"; include("head.php"); ?>
<div class="container">
    <div class="row">
        <div class="col-12 col-lg-6 offset-lg-3">
            <h2 class="mt-4 mb-4">Terms of Service</h2>
            <p>Last Updated December 24, 2022</p>
            <p>This is essentially just a list of rules for our platform. We reserve the right to update this at any time without any notice, so check here frequently in case the terms are updated. For privacy information, <a href="/auth/privacy">click here</a>.</p>
            ...
            <p>These apply to all text inputs on both the site and client, such as forum posts and in-game chat.</p>
            <ul>
                <li>
            ...
            <ul>
                ...
                <li>
                    <span class="fw-bolder">A few alternate accounts is OK.</span> You can create an alt by simply registering.
                </li>
                <li>
