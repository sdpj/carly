...
include('Header.php');
				...
				$c = 0;
				?>
                <center><h1 style="color: red;">Do not accept Hats, Backgrounds or Accessories from non-premium or non-artist members!</h1></center><br>
                <table><tr>
                <?php
