				...
				<div id='Login'>
					<left>
						...
						<img src='/Avatar2D.php?ID=$myU->ID'>
                                                <center position:absolute; TOP:35px; LEFT:170px; WIDTH:350px; HEIGHT:350px>
                                               <b>Welcome to AvatarBlocks!</b> 
						<br />
                                           A place where people can play games and create cool avatars or just talk to each other.
