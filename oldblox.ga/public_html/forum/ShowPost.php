...
?>	
	<div class='forum-thread-page' style='padding-top:10px;'>
		...
		&raquo;
		 <a href='/forum/Group.aspx?ID=<?echo$GroupID;?>'>
			<b><?echo$GroupName;?></b>
		</a>
		&raquo;
		 <a href='/forum/ShowForum.aspx?ID=<?echo$Topic->ID;?>'>
		...
		<div style='margin-bottom:7px;'>
			...
			<div style='float:right;margin-bottom:7px;'>
				<a href='/forum/ShowPost.aspx?ID=<?echo $prev;?>'>
					<b>Previous Thread</b> 
				</a>
				<b>::</b> 
				<a href='/forum/ShowPost.aspx?ID=<?echo $next;?>'>
					<b>Next Thread</b>
				</a>
			</div>
		</div>
					...
					<table cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td class='avatar-stats' style='text-align:center;left:0;top:0;'>
									<a href='/user.aspx?ID=<?echo"".$Poster->ID."";?>'>
										<b><?echo"".$Poster->Username."";?></b>
										<br />
										<center>
											<img src='/Avatar.aspx?ID=<?echo"".$Poster->ID."";?>'>
										</center>
							...
							<?if($Poster->PowerForumModerator == "true"){
								...
								<tr>
									<td class='mod-image'>
										<img src='/Images/users_moderator.gif'>
									</td>
								</tr>
								";
							}?>
							...
							<h3 style='font-weight:normal;margin:0;padding:0;'>
								...
								<?if ($User) {
									if($Thread->Locked == "1" && $myU->PowerForumModerator == "true"){
										...
										<div style='float:left;bottom:0px;padding-left:5px;'>
											<a href='/forum/Reply.aspx?ID=".$Thread->ID."' class='btn-control-prof' style='font-size:12px;'>
								...
								if($User){
									...
									<div style='float:right;bottom:0px;padding-right:5px;'>
										<a href='/abuse/report-forum-post.aspx?ID=".$Thread->ID."' style='font-weight:normal;color:#06C;'>
											Report Abuse
										</a>
									</div>
									";
									...
									echo"
									<div style='float:right;bottom:0px;padding-right:5px;'>
										<a href='/Login.aspx?&RedirectUrl=/forum/ShowPost.aspx?ID=".$Thread->ID."' style='font-weight:normal;color:#06C;'>
											Login to Report
										</a>
									</div>
									";
								...
								if ($User) {
									if ($myU->PowerForumModerator == "true") {
										if(!$Thread->OriginalTitle||!$Thread->OriginalBody){
											echo"
											<div style='float:left;bottom:0px;padding-left:5px;'>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=main&Moderation=scrub' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Scrub
													</div>
												</a>
										...
										echo"
										<div style='float:left;bottom:0px;padding-left:5px;'>
											<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=main&Moderation=delete' class='btn-control-prof' style='font-size:12px;'>
												<div style='margin-top:4px;'>
													Delete
												</div>
											</a>
										...
										if($Thread->Locked == "1"){
											echo"
											<div style='float:left;bottom:0px;padding-left:5px;'>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=main&Moderation=unlock' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Unlock
													</div>
												</a>
										...
										elseif($Thread->Locked == "0"){
											echo"
											<div style='float:left;bottom:0px;padding-left:5px;'>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=main&Moderation=lock' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Lock
													</div>
												</a>
										...
										if($Thread->OriginalTitle||$Thread->OriginalBody){
											...
											<div class='Scrub-Box-Forum'>
												...
												<div style='padding-top:10px;'></div>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=main&Moderation=undoscrub' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Restore Thread
													</div>
												</a>
							...
							<table cellspacing='0' cellpadding='0' width='100%'>
								<tr>
									<td class='avatar-stats' style='text-align:center;'>
										<a href='/user.aspx?ID=".$Poster->ID."'>
										<b>".$Poster->Username."</b>
											<br />
											<center>
												<img src='/Avatar.aspx?ID=".$Poster->ID."'>
											</center>
											";
							...
							<div style='margin:0;padding:5px;'>
								<h3 style='font-weight:normal;margin:0;padding:0;'>
									...
									if($User){
										echo"
										<div style='float:right;bottom:0px;padding-right:5px;'>
											<a href='/abuse/report-reply.aspx?ID=".$Reply->ID."' style='font-weight:normal;color:#06C;'>
												Report Abuse
											</a>
										</div>
										";
										...
										echo"
										<div style='float:right;bottom:0px;padding-right:5px;'>
											<a href='/Login.aspx?&RedirectUrl=/forum/ShowPost.aspx?ID=".$Thread->ID."#".$Reply->ID."' style='font-weight:normal;color:#06C;'>
												Login to Report
											</a>
										</div>
										";
									...
									if ($User) {
										if ($myU->PowerForumModerator == "true") {
											if(!$Reply->OriginalBody){
												echo"
												<div style='float:left;bottom:0px;padding-left:5px;'>
													<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=reply&ReplyID=".$Reply->ID."&Moderation=scrub' class='btn-control-prof' style='font-size:12px;'>
														<div style='margin-top:4px;'>
															Scrub
														</div>
													</a>
											...
											echo"
											<div style='float:left;bottom:0px;padding-left:5px;'>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=reply&ReplyID=".$Reply->ID."&Moderation=delete' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Delete
													</div>
												</a>
										...
										if($Reply->OriginalBody){
											...
											<div class='Scrub-Box-Forum' style='margin-top:50px;'>
												...
												<div style='padding-top:10px;'></div>
												<a href='/forum/ShowPost.aspx?ID=".$Thread->ID."?&ThreadType=reply&ReplyID=".$Reply->ID."&Moderation=undoscrub' class='btn-control-prof' style='font-size:12px;'>
													<div style='margin-top:4px;'>
														Restore Reply
													</div>
												</a>
...
<?
	if($User && $myU->PowerForumModerator == "true"){
		...
		if($Moderation == "scrub" && $myU->PowerForumModerator == "true" && !$Thread->OriginalTitle && !$Thread->OriginalBody && $ThreadType == "main"){
			...
			header("Location: /forum/ShowPost.aspx?ID=".$ID."");
			die();
		}
		if($Moderation == "delete" && $myU->PowerForumModerator == "true" && $ThreadType == "main"){
			...
			header("Location: /forum/ShowForum.aspx?ID=".$Thread->tid."");
			die();
		}
