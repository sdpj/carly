...
Route::group(array('before' => 'install'), function()
{
	...
	Route::group(array('prefix' => '/forum'), function()
	{
		...
		Route::get('thread/{id}/delete', ['before'=>'auth|forumMod','uses'=>'AdminController@DeleteThread'])->where('id','[0-9]+');
		Route::get('thread/{id}/restore', ['before'=>'auth|forumMod','uses'=>'AdminController@RestoreThread'])->where('id','[0-9]+');
		Route::get('thread/{id}/lock', ['before'=>'auth|forumMod','uses'=>'AdminController@LockThread'])->where('id','[0-9]+');
		Route::get('thread/{id}/unlock', ['before'=>'auth|forumMod','uses'=>'AdminController@UnlockThread'])->where('id','[0-9]+');
		Route::get('thread/{id}/sticky', ['before'=>'auth|forumMod','uses'=>'AdminController@StickyThread'])->where('id','[0-9]+');
		Route::get('thread/{id}/unsticky', ['before'=>'auth|forumMod','uses'=>'AdminController@UnstickyThread'])->where('id','[0-9]+');
		Route::post('thread/{id}/move', ['before'=>'auth|forumMod','uses'=>'AdminController@MoveThread'])->where('id','[0-9]+');
		Route::get('post/{id}/delete', ['before'=>'auth|forumMod','uses'=>'AdminController@DeletePost'])->where('id','[0-9]+');
		Route::get('post/{id}/scrub', ['before'=>'auth|forumMod','uses'=>'AdminController@ScrubPost'])->where('id','[0-9]+');
		Route::get('post/{id}/unscrub', ['before'=>'auth|forumMod','uses'=>'AdminController@UnscrubPost'])->where('id','[0-9]+');
		Route::get('post/{id}/edit', ['before'=>'auth|forumMod','uses'=>'AdminController@EditPost'])->where('id','[0-9]+');
		Route::post('post/{id}/edit', ['before'=>'auth|forumMod','uses'=>'AdminController@DoEditPost'])->where('id','[0-9]+');
	});
	...
	Route::group(array('prefix' => '/store'), function()
	{
		...
		Route::get('upload', ['before'=>'auth|canUpload','uses'=>'StoreController@ShowUpload']);
		Route::post('upload', ['before'=>'auth|canUpload','uses'=>'StoreController@DoUpload']);
