...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" xmlns:fb="http://www.facebook.com/2008/fbml"> 
	<head>
		...
		<!--<script type="text/javascript" src="http://avatar-gamer.ga/snowstorm.js"></script>-->
		<script type="text/javascript" src="http://ajax.microsoft.com/ajax/jquery/jquery-1.6.2.min.js"></script>
		<script type="text/javascript" src="http://www.tumuski.com/library/Nibbler/Nibbler.js"></script>
		<style>
		#nav_link:hover
		{
-webkit-box-shadow: 0px 0px 16px rgba(50, 50, 50, 0.30);
-moz-box-shadow:    0px 0px 16px rgba(50, 50, 50, 0.30);
box-shadow:         0px 0px 16px rgba(50, 50, 50, 0.30);
		}
		</style>
		<script>
		...
		<div align='center'>
			<div id='Header'>
				<table cellspacing='0' cellpadding='0' width='1100'>
					<tr>
						<td width='200'>
							<img src='http://avatar-gamer.ga/Imagess/SPNewLogo.png'  height='40'>
						</td>
						<td>
							<table cellspacing='0' cellpadding='0'>
								<tr height='40px'>
									<td id='nav_link'>
										<a href='http://avatar-gamer.ga/'>Home</a>
									</td>
									<td id='nav_link'>
										<a href='http://avatar-gamer.ga/users/'>Users</a>
									</td>
									<td id='nav_link'>
										<a href='http://avatar-gamer.ga/Store/Store.php'>Shop</a>
									</td>
									</td>
									<td id='nav_link'>
										<a href='http://avatar-gamer.ga/Groups/'>Groups</a>
									</td>
									<td id='nav_link'>
										<a href='http://avatar-gamer.ga/Forum/'>Forum</a>
									</td>
									</td>
									<?php
								...
								//		";
									...
									<td>
										<a href='http://avatar-gamer.ga/Logout.php'>Logout</a>
									</td>
										";
										...
										echo "
									<td style='padding-left:35px;'>
										<a href='http://avatar-gamer.ga/Login.php'>Login</a>
									</td>
									<td>
										<a href='http://avatar-gamer.ga/register.php'>Register</a>
									</td>
										";
