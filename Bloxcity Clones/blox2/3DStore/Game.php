...
include($_SERVER['DOCUMENT_ROOT']."/Header.php");
	...
	$getItem = mysql_query("SELECT * FROM Games WHERE ID='".$ID."' AND itemDeleted='0'");
								...
								<table>
									<tr>
										...
										<td align='left' valign='top'>
											<font color='blue'><b>Port: ".$gI->Price."</b></font> &nbsp; &nbsp; ";											
										...
										<td valign='top' align='left' width='300'>
											";
											if ($myU->PowerAdmin == "false"||$myU->PowerMegaModerator == "false"||$myU->PowerImageModerator == "false"||$gI->CreatorID == $myU->ID) {
											echo "
											<br />
											<div id='ProfileText'>
											<a href='nobeliumprotocol://'>Play</a>
			...
			<td>
				<div id='ProfileText'><a name='Comments'></a>
					...
					<form action='#comments' method='POST'>
						<textarea name='Reply' rows='5' style='width:90%;' placeholder='i.e This game is so cool!!!'></textarea>
						<br />
					...
					if ($gI->saletype == "limited"&&$gI->numberstock == "0") {
						...
						elseif ($tG == "0") {
							...
							mysql_query("INSERT INTO Logs (UserID, Message, Page) VALUES('".$myU->ID."','purchased ".$gI->Name." for ".$Price."','".$_SERVER['PHP_SELF']."')");
																...
																mysql_query("INSERT INTO PurchaseLog (UserID, Item, Action, TypeStore, ItemType, SellerID, Price, time) VALUES('$myU->ID','$gI->Name','Games_purchase','User Shop','regular','$myU->Username','$Price','".time()."')");
