...
if($maintenance == 0){
	...
	if($user['USERNAME']=='Hello'){ // u can add mroe people
		...
		if (strpos($_SERVER['REQUEST_URI'], "maintain") !== false){
			...
			<center style='font-family:Arial, Terminal;'>
				<text style='font-size:60px;font-weight:bold;position:fixed;left:20%;top:35%;'>cygo is in<br>Maintenance<br><br>
...
<div style='width:100%;z-index:2;background-color:white;color:black;padding:10px;border:1px solid black;border-top:0px;border-radius-bottom-left:5px;border-radius-bottom-right:5px;position: fixed;' id='navbar'>
	<!--<a style='margin-right:5.5px;margin-left:5.5px;color:grey;' href='#'>LOGO</a>-->  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Dashboard/'>Dashboard</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Emporium/'>Emporium</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Play/'>Play</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Forums/'>Forums</a>  |   <a style='margin-right:5.5px;margin-left:5.5px;' href='/News/'>News</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Search/'>Search</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Friends/'>Friends</a>  
	";
...
<div style='color:white;width:99.9%;background-color:green;padding:10px;padding-top:60px;position:fixed;z-index:-1;'>
	<center>
		<b>expect items to be deleted since this is a test</b>
	</center>
</div> 
