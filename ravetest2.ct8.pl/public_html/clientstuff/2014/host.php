...
local placeId, sleeptime, port, url, timeout, access = <?=$_GET['place'];?>, 0, <?=$_GET['port'];?>, "http://www.yrk.ct8.pl", 0, "8169b38d-abbc-480f-8971-14d8fd560aad"
...
function reportCdn(blocking)
	...
	pcall(function()
		...
		if successDelta > 0 or failureDelta > 0 then
			...
			game:HttpGet("http://www.yrk.ct8.pl/Game/Cdn.ashx?source=server&success=" .. successDelta .. "&failure=" .. failureDelta, blocking)
