<?
	...
	if(!$User){
		header("Location: /Landing/Animated/?redirecturl=/forum/MyThreads.aspx");
		die();
	}
	$Setting = array(
	"PerPage" => 15
...
<?
	...
	if ($Page > 1) {
	echo '<a href="/forum/MyThreads.aspx?&Page='.($Page-1).'">Previous</a> - ';
	}
	echo '<b>Page '.$Page.' of '.(ceil($num / $Setting["PerPage"]));
	echo'</b>';
	if ($Page < ($amount)) {
	echo ' - <a href="/forum/MyThreads.aspx?&Page='.($Page+1).'">Next</a>';
	}
?>
<?
	include($_SERVER['DOCUMENT_ROOT'].'/Header.php');
