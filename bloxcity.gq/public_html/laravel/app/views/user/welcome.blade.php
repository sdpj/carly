...
@else
	...
	{{ Form::open(array('url' => '/user/welcome', 'autocomplete' => 'off'))}}
		...
		<h3 class="subtitle tac">This is NOT racism But the code doesnt want to fucking change the images ps: you will have a blocky avatar</h3>
		...
		<div id="welcome-race"> 
			...
			<label for="black-one">Black One</label> 
