...
$Hat = "hat";
					...
					// HEAD
					THREE.ImageUtils.crossOrigin = "";
					var texture =  THREE.ImageUtils.loadTexture("/Store/Dir/<?if (empty($Face)) {
$Face = "defaultface";
}; echo"$Face";?>.png");
					var texturetwo =  THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
					
					var textureHead = THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
					var textureLeftArm = THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
					var textureTorso = THREE.ImageUtils.loadTexture("/Store/Dir/yellow.png");
					var textureRightArm = THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
