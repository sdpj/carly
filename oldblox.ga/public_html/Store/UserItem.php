				...
				<div id='ProfileText'>
					...
					<table width='100%'>
						<tr>
							...
							if($gI->active == "1"){
								echo"
								<a href='http://rega-gaming.mlStore/UserItem.aspx?ID=".$gI->ID."'>
								...
								<a href='http://rega-gaming.mlStore/UserItem.aspx?ID=".$gI->ID."'>
									<div style='width:100px;border:1px solid #ccc;padding:3px;'>
										<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(http://gamelabs.social-verse.ml/Store/Dir/image_denied.png);'>
										</div>
									</div>
								</a>
								";
								...
								<a href='http://rega-gaming.mlStore/UserItem.aspx?ID=".$gI->ID."'>
									<div style='width:100px;border:1px solid #ccc;padding:3px;'>
										<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(http://gamelabs.social-verse.ml/Store/Dir/pending_moderation.png);'>
										</div>
									</div>
								</a>
								";
								...
								<table>
									<tr>
										...
										<td align='left' valign='top'>
											<font color='green'><b>Bux: $".$gI->Price."</b></font> &nbsp; &nbsp; "; if ($gI->sell == "yes"&&$gI->active != 0) {if($gI->active != 2){ if ($Status->ItemStatus == 0) { echo "<input type='submit' id='buttonsmall' value='Buy' name='Buy'></form>"; } else { echo "<font color='red'>Sorry, we are not allowing purchases at this time. Please try again later.</font>"; } } }
