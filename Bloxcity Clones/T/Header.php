...
if($gC->Avatars == "3D"){
echo"<li><a href='/Store/UserStore.php' style='color: white;'><span class='glyphicon glyphicon-shopping-cart' style='color: white;'></span>&nbsp;&nbsp;Store</a></li>";}elseif($gC->Avatars == "2D"){
echo"        <li>
...
<li><a href='#' style='color: lightgreen;'>$Bux Bux</a></li>
          ...
          <ul class='dropdown-menu' role='menu'  style='color: #d9534f;'>
            ...
            <li><a href='Admin.php'  style='color: #d9534f;'><span class='glyphicon glyphicon-wrench'  style='color: #d9534f;'></span>&nbsp;&nbsp;Admin Panel</a></li>
