<?php
$con = mysql_pconnect("localhost", "YourUser", "YourPassword") or die("Something went wrong while connecting to the database - ID: 1");
mysql_select_db("YourDB", $con) or die("Something went wrong while connecting to the database - ID: 2");
$isDown = false;
if ($isDown == true){
	if ($_COOKIE['allow']){
