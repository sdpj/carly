...
$connection = mysql_pconnect("mysql.ct8.pl","m23624_nobrlium","Sg090228") or die("Error connecting to database, hang tight, we are working on it.");
mysql_select_db("m23624_nobrlium") or die("Error connecting to database, hang tight, we are working on it.");
	/*Filter */
