<?php
	...
	if (!$code) {
	echo "
	Hi. If you forgot your password, please type in the username. It will send an email with the account registered on. If the email is fake/no email, we can not help you.
	<br />
    ...
    $header .= "From: Firesplash <fire@info.com>\r\n"; 
    $header .= "Reply-To: Firesplash <fire@info.com>\r\n"; 
    $header .= "Return-Path: Firesplash <fire@info.com>\r\n"; 
    $header .= "Content-Type: text/plain\r\n";
	$body = "Hello there, ".$gU->Username."! We have received a request to reset your password. Please click this link: http://www.firesplash.tk/ForgotPassword.php?code=".$gU->Hash." to reset your password. If you did not request to reset your password, please disregard this email.";
