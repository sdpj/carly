...
<div class="header-text" style="font-size:18px;padding-bottom:5px;">Customize avatar</div>
<div class="content-box center-align">
<div style="position:absolute; width:186; height:186; z-index:1; background-image:url('../img/item/<?php print_r($myu->outfit); ?>');"></div>
<div style="position:absolute; width:186; height:186; z-index:1; background-image:url('../img/item/<?php print_r($myu->hair); ?>');"></div>
<div style="position:absolute; width:186; height:186; z-index:1; background-image:url('../img/item/<?php print_r($myu->hat); ?>');"></div>

<div style="width:186; height:186; z-index:0; background-image:url('../img/item/slaveguy.png');"></div>
</div>
<div style="height:15px;"></div>
<div class="header-text" style="font-size:18px;padding-bottom:5px;">Avatar</div>
<div class="content-box center-align">
<div style="background:#C8F110;width:35px;height:35px;margin:0 auto;cursor:pointer;" onclick="showPalette('head')" id="head"></div>
<div style="height:5px;"></div>
<div style="background:#C8F110;width:35px;height:75px;margin:0 auto;cursor:pointer;display:inline-block;" onclick="showPalette('leftarm')" id="leftarm"></div>
<div style="background:#1081F1;width:75px;height:75px;margin:0 auto;cursor:pointer;display:inline-block;" onclick="showPalette('torso')" id="torso"></div>
<div style="background:#C8F110;width:35px;height:75px;margin:0 auto;cursor:pointer;display:inline-block;" onclick="showPalette('rightarm')" id="rightarm"></div>
<div style="clear:both;display:block;"></div>
<div style="margin-top:-3px;">
<div style="background:#3DA317;width:35px;height:75px;margin:0 auto;display:inline-block;" onclick="showPalette('leftleg')" id="leftleg"></div>
<div style="background:#3DA317;width:35px;height:75px;margin:0 auto;display:inline-block;" onclick="showPalette('rightleg')" id="rightleg"></div>
</div>
</div>
</div>
