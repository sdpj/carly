	...
	var _game = {
		...
		player: {
			...
			create: function() {
				...
				_game.player.model = _three.createModel(window.game.models.player, 14, [ //fov
		...
		level: {
			...
			create: function() {
				...
				// Add some boxes
					...
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.bpr }),
					physicsMaterial: _cannon.solidMaterial });
				...
				grid.position.z = 0.5;
				grid.rotation.x = window.game.helpers.degToRad(90); //90 degree
				//_three.scene.add(grid); //we do not want grid
			}
		},
...
/*
    ...
    var textGeom = new THREE.TextGeometry( 'Hello World!', {
        font: 'roboto medium' // Must be lowercase!
    });
    var textMesh = new THREE.Mesh( textGeom, tmaterial );
