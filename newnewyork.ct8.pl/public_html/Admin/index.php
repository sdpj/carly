...
mysql_query("UPDATE banner SET text='".$announcement."'");
mysql_query("INSERT INTO Logs (Userid, Message, Page) 
VALUES('".$myu->id."','changed the banner to: $announcement','".$_SERVER['PHP_SELF']."')");
...
<a class="link-side" onclick="game()" id="game" style="background-color: rgb(242, 242, 242);">Pending Approval</a>
...
<div class="header-text">Pending Approval</div>
<p>This feature is coming soon.</p>
</div>
<div id="create-group" style="display: none;" class="card-0-2-28">
<div class="fw-700 font-size-18 mb-2 lighten-2">Ban User</div>
<form action="ban.php" method="GET" enctype="multipart/form-data">
Enter the user's ID below.
<input type="text" class="general-textarea" name="id" id="GroupName" style="width:100%;">

<div style="height:15px;"></div>
<input type="submit" name="go" class="btn-0-2-183 wearButton-0-2-189 continueButton-0-2-39" value="Continue">
<div style="height:15px;"></div>
<div style="font-size:14px;">Banning the user will prevent them from accessing the site.</div>
</form>
</div>
...
<div id="create-tshirt" style="display: none;" class="card-0-2-28">
<div class="fw-700 font-size-18 mb-2 lighten-2">Announcement</div>
<form action="" method="POST" enctype="multipart/form-data">
Enter the announcement below.
<input type="text" class="general-textarea" name="announcement" id="GroupName" style="width:100%;">

<div style="height:15px;"></div>
<input type="submit" name="go" class="btn-0-2-183 wearButton-0-2-189 continueButton-0-2-39" value="Submit">
<div style="height:15px;"></div>
<div style="font-size:14px;">All changes to the banner will be logged into our database.</div>
</form>
</div>
