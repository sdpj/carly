...
if ($_GET['id']){
	...
	?>
   <center> <a href="index.php">Avatar Central Forums</a> &rarr; <a href="Forum.php?id=<?php print_r($oldy['inid']); ?>"><?php print_r($forumin['name']); ?></a> &rarr; <a href="Thread.php?id=<?php print_r($id); ?>"><?php print_r($oldy['subject']); ?></a> &rarr; <a href="#">Reply</a></center><br><br> 
