...
<table width='98%'>
	<tr>
		<td width='40%'>
			";
			if($User) { if($myU->PowerArtist == "false") { echo " "; } else
			echo "
				<a href='/UserUpload/'>Upload Item</a>
			<br />
			";
			}
			echo "
				<table>
					<tr>
						<td>
							<a href='?Sort=Eyes' style='font-weight:bold;color:#777;'>Eyes</a> 
						</td>
					</tr>
					<tr>
						<td>
							<a href='?Sort=Mouths' style='font-weight:bold;color:#777;'>Mouths</a>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<a href='?Sort=Pants' style='font-weight:bold;color:#777;'>Pants</a>
						</td>
					</tr>
					<tr>
						<td>
							<a href='?Sort=Shirts' style='font-weight:bold;color:#777;'>Shirts</a>
						</td>
					</tr>
					<tr>
						<td>
...
<tr>
						<td>
							<a href='?Sort=Body' style='font-weight:bold;color:#777;'>Packages</a>
						</td>
					</tr>
	<td>
							<a href='?Sort=Background' style='font-weight:bold;color:#777;'>Skyboxes</a>
						</td>
					</tr>
...
echo "<center><table><tr>";
		...
		while ($gI = mysql_fetch_object($getItems)) {
			...
			<td style='font-size:11px;' align='left' width='100' valign='top'><a href='/UserItem?ID=".$gI->ID."' border='0' style='color:black;'>
				<div style='border:1px solid #ccc;border-radius:5px;padding:5px;'>
					<img src='/Store/Dir/".$gI->File."' width='100' height='100'>
				</div>
				<b>".$gI->Name."</b></a>
				<br />
