	...
	if(ISSET($_COOKIE['EPICNAME']) && ISSET($_COOKIE['EPICPASS'])){
		...
		if($account > 0){
			...
			<center>
					...
					<h1><div style='width:75px;height:75px;border:1px solid grey;border-radius:0px;overflow:hidden;' class='circle'><img src='$user[AVATAR_IMG_URL]' width='105' style='margin-left:-13px;margin-top:-25px;'></div>$user[USERNAME]</h1></div>
						</body>";
