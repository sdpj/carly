		...
		$counter = 0;
			...
			while ($gD = mysql_fetch_object($getDrafts)) {
				...
				if ($Release == "yes") {
					...
					VALUES ('$gI->Name','$gI->File','$gI->Type','$gI->Price','$gI->CreatorID','$gI->saletype','$gI->numbersales','$gI->numberstock','$gI->sell','$gI->Description','$now','$gI->store','$gI->timemake','$gI->itemDeleted','$gI->SalePrices','$gI->NumberSold')");
