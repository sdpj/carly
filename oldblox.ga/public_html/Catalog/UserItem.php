				...
				<div id='ProfileText'>
					...
					<table width='100%'>
						<tr>
							...
							if($gI->active == "1"){
								echo"
								<a href='/Store/UserItem.aspx?ID=".$gI->ID."'>
								...
								<a href='/Store/UserItem.aspx?ID=".$gI->ID."'>
									<div style='width:100px;border:1px solid #ccc;padding:3px;'>
										<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(/Store/Dir/image_denied.png);'>
										</div>
									</div>
								</a>
								";
								...
								<a href='/Store/UserItem.aspx?ID=".$gI->ID."'>
									<div style='width:100px;border:1px solid #ccc;padding:3px;'>
										<div style='width: 100px; height: 200px; z-index: 3;  background-image: url(/Store/Dir/pending_moderation.png);'>
										</div>
									</div>
								</a>
								";
