...
//query
$num = mysql_num_rows($allusers = mysql_query("SELECT * FROM Users WHERE PowerAdmin='true' AND $now < expireTime"));
$Num = ($Page+8);
			$OnlineNow = mysql_query("SELECT * FROM Users WHERE PowerAdmin='true' AND $now < expireTime LIMIT {$Minimum},  ". $Setting["PerPage"]);
			$NumOnline = mysql_num_rows($OnlineNow);
	echo "
	<div id='TopBar'>
	$num <b> Admin(s) </b> Are Online
	</div>
	<div id='aB'>
