...
$addMiddle = '
LeftArmImg = bpy.data.images.load(filepath="/storage/store_storage/shirts/'.$user->shirt.'")
...
RightArmImg = bpy.data.images.load(filepath="/storage/store_storage/shirts/'.$user->shirt.'")
...
TorsoImg = bpy.data.images.load(filepath="/storage/store_storage/shirts/'.$user->shirt.'")
