<? include("head.php"); $authpage = "true"; include('../api/user/sign_in_account.php'); ?>
    ...
    <div class="row">
        <div class="col-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4">
            <div class="card card-body">
                <h2>Login</h2>
                    <p>If you do not have an account, you can <a href="/auth/register">create one here</a>.</p>
                <form method="post">
                    ...
                    <input class="btn btn-primary" type="submit" value="Login" id="login-submit" name="submit">
                </form>
            </div>
        </div>
    </div>
