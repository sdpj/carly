...
<a href='?type=HEAD'><button style='border-radius:20px;padding:5px;color:black;'>Hats</button></a><a href='?type=HEAD_2'><button style='border-radius:20px;padding:5px;color:black;'>Second Hats</button></a><a href='?type=FACE'><button style='border-radius:20px;padding:5px;color:black;'>Faces</button></a><a href='?type=MASK'><button style='border-radius:20px;padding:5px;color:black;'>Face Accessories</button></a><a href='?type=BODY'><button style='border-radius:20px;padding:5px;color:black;'>Third Hats</button></a><a href='?type=TOOL'><button style='border-radius:20px;padding:5px;color:black;'>Tools</button></a><a href='?type=SHIRT'><button style='border-radius:20px;padding:5px;color:black;'>Shirts</button></a><a href='?type=TROU'><button style='border-radius:20px;padding:5px;color:black;'>Pants</button></a><input style='style='border-radius:100px;padding:5px;color:black;' class='Ginputs' placeholder='Search for items here!' name='username' maxlength='20'></input>
							</form><a href='../Catalog/upload'><button style='border-radius:20px;padding:5px;color:white;background:green;'>Create</button></a>
						<div id='platform' style='width:1200px;border:1px solid black;background-color:white;border-top-right-radius:10px;border-top-left-radius:10px;padding:20px;padding-top:0px;padding-bottom:0px;display:flex;flex-wrap:wrap;'>
							<div style='display:inline-block;width:20%;border-right:1px solid;text-align:left;'>
								<b><br><a style='color:grey;font-size:22.5px;'>Filters (Soon)</a><br></b>
								...
								if(isset($_GET['page'])){
									...
									if(is_numeric($page)){
										if($page >= 1){
											...
											exit("<script>window.location='../Store';</script>");
										}
									}else{
										exit("<script>window.location='../Store';</script>");
									}
