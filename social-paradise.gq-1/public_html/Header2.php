...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" xmlns:fb="http://www.facebook.com/2008/fbml"> 
	...
	<?php  if ($User) { echo "<center>
		<div id='SubBar'>
		<table cellspacing='0.2' cellpadding='0.2'>
			<tr>
				<td>
					<a href='http://reborn2go.epizy.com/'>Home</a>
				</td>
				<td>
				    <a href='/'>-</a>
				</td>
				<td>
					<a href='http://reborn2go.epizy.com/user.php?ID=$myU->ID'>Public Profile</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/account.php'>Account</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/Store/UserStore.php'>Store</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/Groups/'>Groups</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/forum/'>Forum</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/Memberships/UpgradeAccount.php'>Upgrade</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/users/'>Users</a>
				</td>
				<td>
					<a href='http://reborn2go.epizy.com//character.php'>Character</a>
				</td>
				<td>
					<a href='http://reborn2go.epizy.com/FriendRequests.php'>Friend Requests ($FriendsPending)</a>
				</td>
				<td>
					<a href='http://reborn2go.epizy.com/inbox.php'>Inbox ($PMs)</a>
				</td>
				<td>
					<a href='http://reborn2go.epizy.com/Blog/'>Blog</a>
				</td>
				<td>
				    <a href='http://reborn2go.epizy.com/Logout.php'>Logout</a>
				</td>
			</tr>
		</table>
		</div>
