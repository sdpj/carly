...
$Type = $gI->Type;
  ...
  echo "<td align='center' valign='top' style=''>$echo1<img src='/Store/Dir/thingTransparent.png' width'100 height'100'><br><!--<img src='/Store/Dir/".$gI->File."' width='100' height='200'>--><notice style='float:left;'></notice></a><br><a href='".$Link."?ID=".$gI->ItemID."' border='0' title='".$gN->Name."'><br />".$TheItemName."<br><font size='2'>
  ";
  echo "
  ";
...
for (var i = 0; i < arr.length; i++) {
   arr[i].innerHTML = \"rendering... please wait some minutes.\";
}</script>";
}
include "Footer.php";