											...
											<tr>
												<td valign='top'>
													...
													<div style='height:100px;width:100px;overflow-y:hidden;'>
														...
														";
														drawAvatar($gC->PosterID, 100, 195);
														echo "
													</div>
													";
												...
												<td valign='top' style='width:900px;'>
													...
													if ($myU->ID == $gG->OwnerID) {
														...
														echo "
														<br /><br />
														<a href='?ID=1&WallAction=Delete&WallID=$gC->ID'><font color='red'><b>Delete</b></font></a>
														";
