...
<h5 style="padding-bottom:20px;">Upload Pants</h5>
...
<br><br><font color='black' style='font-size:10pt;color:red;'>If you upload content from another website that owns the rights to such content, the content will be removed from ThinkBlocks and your account will be terminated.</font></div>
</form>
</div>
</div>
<div class="col s6">
...
if(move_uploaded_file($_FILES['uploaded']['tmp_name'], $target))
 ...
 VALUES ('$itemname','".$_FILES['uploaded']['name']."','Bottom','$itemprice','$myU->ID','regular','$_POST[numbersold]','$_POST[numbersold]', '$time')");
