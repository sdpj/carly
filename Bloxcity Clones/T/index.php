...
$gU = mysql_fetch_object($getUser);
        ...
        <div id='Login'>
          ...
          <img src='/Avatars/$myU->Avatar3D' width='256' height='256' style='position:absolute;left:-50px;'>
                                               ...
                                               <!--<b>Welcome to ThinkBlocks!</b> 
                                                <br />
            <br />
                                           ThinkBlocks is an online social hangout!-->
          </center>

        </div>
        
          
          <div class='col s6' style='width:449px;position:absolute; TOP:175px; LEFT:170px;'>
<div class=\"bc-content\" style=\"font-size:14px;\">
<h5 style=\"padding-bottom:20px;\">Welcome to Avatarblocks!</h5>
testing
</div>
