...
<div class="light-blue lighten-1" style="color:white;padding:15px 25px;background: #600e74; background: linear-gradient( 90deg ,#600e74,#fe00b0); border: 0;">

<div class="row valign-wrapper" style="margin-bottom:0;">

<div class="col s8 m8 l8 valign">

<div style="font-size:16px;"><?php echo $name;?> Forums</div>
...
<a href="/Forum/Topic?id=<? echo $gT->id ?>" style="color:#333;">
