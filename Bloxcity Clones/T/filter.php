...
$connection1 = @mysql_connect("mysql.ct8.pl","m27001_social","Sg090228") or die("We are currently overloaded with users. Please try again in 1-5 minutes. Do not constantly refresh the page.");
mysql_select_db("m27001_social") or die("We are currently overloaded with users. Please try again in 1-5 minutes. Do not constantly refresh the page.");
  ...
  //array
  $words = array("fuck", "bitch", "tranny", "asshole", "cunt", "dick", "nigga", "nigger", "penis", "vagina", "pussy", "sex", "blowjob", "s3x", "shit", "cum", "sperm", "lesbian", "slut", "anal", "penus", "cock", "tits", "weed", "faggot");
  $new =   array("****", "*****", "******", "*******", "****", "****", "*****", "******", "*****", "******", "*****", "***", "*******", "***", "****", "***", "*****", "*******", "****", "****", "*****", "****", "****", "****", "******");
