...
<h1 class="pageTitle-0-2-247" style="margin-left:1rem;">Groups</h1>
...
<div style="font-size:14px;color:#888888;"><?=mb_strimwidth(htmlspecialchars($gG->description), 0, 159, "...");?></div>
</div>
<div class="col s2 valign center-align">
