...
<link rel="icon" type="image/png" href="/logo.png"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"></head>
<style>
html, body {
    max-width: 100%;
    overflow-x: hidden;
...
<script>
      function render() {
        ...
        $('#avatar').html( '<img src="/images/loading.gif" style="width:300px;height:300px;border-top: 30px solid #fff;border-bottom: 30px solid #fff;">' );
        
        $.get ('render.php', function ( result ) {
            
            if (result != "false") {
                document.getElementById("avatar").innerHTML = '<img src="/images/' + result + '" style="width:300px">';
            } else {
                $.get ('render.php', function ( result ) {
                    document.getElementById("avatar").innerHTML = '<h4>There seems to be an issue! Please try again!</h4><img src="/images/'+result+'.png" style="width:300px">';
                });
            }
...
<script>
setTimeout(function() {
                      document.getElementById("avatarr").setAttribute("src", "/images/' . $user->id . '.png?r=' . $rand . '");
                  }, 800);
</script>
';
echo "
<center>
<div id='avatar'><img src='/images/14.png?r=$rand' style='width:300px'></div>
<br>
</center>
";
?>
