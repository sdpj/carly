	...
	if ($pre_password == $password2){
		...
		if(!preg_match_all($re, $username)){
			...
			if($Account < 1){
				...
				mysqli_query($conn,"INSERT INTO `ec_users` VALUES(NULL,'$username','$password','$email','0','20','0','MEMBER','NONE','NO', '$time', '$time','0', '', '$time', '/EpicClubRebootMisc/IMGS/template.png','$ip','NO','Hello! Im new to Unitorium!', 'Hi, I am new here!','$uni_string','$time')");
				// Create cookies!
