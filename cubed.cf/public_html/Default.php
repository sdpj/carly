...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" xmlns:fb="http://www.facebook.com/2008/fbml">
   <head>
    ...
    <meta property="og:image" content="https://cdn.upload.systems/uploads/pDPrTMVK.png">';
            ...
            echo '<title>Home - Cubed</title>
    <meta property="og:site_name" content="Cubed">
    <meta property="og:title" content="Home - Cubed">
    <meta property="og:type" content="profile">
    <meta property="og:url" content="">
    <meta property="og:description" content="Cubed, it is website. He is for old brick-builder. Good for use.">
    <meta property="og:image" content="https://cdn.upload.systems/uploads/pDPrTMVK.png">';
        }
    } else {
        echo '<title>Home - Cubed</title>
...
<div id="statusUpdateBox" class="middle-column-box" style="/*background-color: rgb(230, 230, 230);*/padding: 3px;background-color:#313437!important;border: 1px solid hsla(0,0%,96.5%,.125);">
<div>
    <form action="messagesecretchat.php" method="post" id="addfeedtofeedyea">
<input name="txtStatusMessage" type="text" id="txtStatusMessage" maxlength="3243141" class="translate text-box text-box-large" style="width: 920px; float: left;" placeholder="What are you up to?" value="" style="background-color:#313437!important;border: 1px solid hsla(0,0%,96.5%,.125);">
<span class="btn btn-primary" style="padding: 0 20px !important; float: right;" id="shareButton" href="javascript:{}" onclick="document.getElementById('addfeedtofeedyea').submit();">Share</span>
</form>
...
<div id="FeedContainer" class="middle-column-box feed-container" style="background-color:#313437!important;">
<h2>Secret Chat</h2>
<div id="FeedPanel">
...
$edittext1 = 'Edit';
$squaredofficialtext = '"Hello! This is the official Cubed account."';
$myfeedtext = 'My Feed';
$timeformat = "g:i A";
...
if(isset($_GET['lang']) || isset($_SESSION['lang'])) {
    if($_GET['lang'] == 'ru' || $_SESSION['lang'] == 'russian') {
        ...
        $edittext1 = 'Изменить';
        $squaredofficialtext = '"Привет! Это оффициальный аккаунт Cubed"';
...
?>
            <link rel="stylesheet" href="Feed.css">
            <div>
<h1 style="color:#ececec;"><?php echo $hellotext; ?>, <?php echo $_SESSION['user']; ?>!</h1>
</div>
<div style="width: 230px;float: left;">
<div class="left-column-boxes user-avatar-container divider-right divider-bottom" style="background-color:#313437!important;border: 1px solid hsla(0,0%,96.5%,.125);">
...
<div class="left-column-boxes divider-right" style="background-color: #313437!important;border: 1px solid hsla(0,0%,96.5%,.125);">
<div>
<h3 class="best-friends-title" style="color:#ececec;"><?php echo $mybestfriendstext; ?></h3>
<div style="float: right; margin-right: 4px;">
<a href="#" class="btn btn-primary" style="color: #fff !important; background-color: #3182ce !important; border-color: #3182ce !important;background-image:none !important;"><?php echo $edittext1; ?></a>
</div>
<div class="clear"></div>
</div>
<div id="bestFriendsContainer" class="best-friends-container"><div class="best-friends">
<div class="user">
<div class="roblox-avatar-image" data-user-id="1" data-image-size="tiny"><div style="position: relative;"><a href="/User.aspx?id=1"><img title="Cubed" alt="Cubed" border="0" height="48" width="48" src="/get_avatar?id=1"></a></div></div>
<div class="info">
<a class="name" href="/User.aspx?id=1">Cubed</a>
<div class="status" style="color:#ececec;"><?php echo $squaredofficialtext; ?></div>
</div>
<div class="clear"></div>
</div>
</div></div>
...
<div class="clear"></div>
 ...
 <div id="FeedificationsContainer" class></div>
<div id="FeedContainer" class="middle-column-box feed-container" style="background-color:#313437!important;border: 1px solid hsla(0,0%,96.5%,.125);">
<h2 style="color:#ececec;text-align:center;"><?php echo $myfeedtext; ?></h2>
<div id="FeedPanel">
<div id="AjaxFeed" class="text">
    <?php
    $resultsperpage = 8;
        ...
        while ($row = $lol->fetch())
        {
            ...
            echo '
            <div class="feed-container" style="border-top: 1px solid hsla(0,0%,96.5%,.125);width:100%;">
<div class="feed-image-container notranslate">
...
<div class="Feedtext" style="color:#ccc;">"' . $content . '"</div>
</span>
