		...
		<tr>
			<td>
				<div id='ProfileText'>
					...
					<table width='100%'>
						<tr>
							<td align='center' width='111' valign='top'>
								<b>Item:</b>
								<div style='border: 1px solid #bbb;border-radius:5px;width:111px;height:111px;'>
									<img src='/Store/Dir/".$gI->Preview."' width='111' height='111'>
								</div>
							</td>
								...
								<table>
									<tr>
										...
										<td align='left' valign='top'>
											<font color='green'><b>Cash: $".$gI->Price."</b></font> &nbsp; &nbsp; "; if ($gI->sell == "yes") { if ($Status->ItemStatus == 0) { echo "<input type='submit' id='buttonsmall' value='Buy' name='Buy'></form>"; } else { echo "<font color='red'>Sorry, we are not allowing purchases at this time. Please try again later.</font>"; } } 
