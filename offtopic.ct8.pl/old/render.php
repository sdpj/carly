...
$importModel = '
import bpy
bpy.ops.wm.open_mainfile(filepath="/render/avatar.blend")
';
}else{
$importModel = '
import bpy
bpy.ops.wm.open_mainfile(filepath="/render/gearavatarright.blend")
';
}

if($user->Hat != "none") {
$importHat = '
hatpath = "/render/models/hats/'.$user->Hat.'.obj"
...
hatImg = bpy.data.images.load(filepath="/render/textures/hats/'.$user->Hat.'.png")
...
if($user->Gear != "none") {
$importGear = '
gearpath = "/render/models/gear/'.$user->Gear.'.obj"
...
gearImg = bpy.data.images.load(filepath="/render/textures/gear/'.$user->Gear.'.png")
...
if($user->Hat2 != "none") {
$importSecondHat = '
hat2path = "/render/models/hats/'.$user->Hat2.'.obj"
...
hat2Img = bpy.data.images.load(filepath="/render/textures/hats/'.$user->Hat2.'.png")
...
$addFace = '
HeadImg = bpy.data.images.load(filepath="/render/textures/faces/'.$user->Face.'.png")
...
$addMiddle = '
LeftArmImg = bpy.data.images.load(filepath="/www/html/storage/store_storage/shirts/'.$user->shirt.'")
...
RightArmImg = bpy.data.images.load(filepath="/www/html/storage/store_storage/shirts/'.$user->shirt.'")
...
TorsoImg = bpy.data.images.load(filepath="/www/html/storage/store_storage/shirts/'.$user->shirt.'")
...
bpy.data.scenes["Scene"].render.filepath = "/images/'.$user->id.'.png"
