...
if ($User)
{
echo "<h1>Character Customizer</h1><center>
<table width='90%'>
  <tr>
    <td style='width:250px;' valign='top'>
      <h2>
        ...
        <div id='aB'>
          <center>
          ";
          echo "<img src='Avatar.aspx?ID=$myU->ID'>";
          echo "
        </div>
        <div class='divider-bottom' style='width:100%;padding-top:10px;padding-bottom:10px;'></div>
      <br />
      <h2>
        What I'm Wearing
      </h2>
      <div id='aB' style='overflow-x:auto;width:348px;'>
        <table><tr>
        ";
        $counter = 0;
        if (!empty($myU->Background)) {
          ...
          if ($check1 == "1") {
            ...
            $gN = mysql_fetch_object($getName);
            $Link = "/Catalog/UserItem.aspx";
          
          }
          
          $getID = mysql_query("SELECT * FROM Inventory WHERE UserID='$myU->ID' AND File='$gN->File'");
          $gI = mysql_fetch_object($getID);
          $echo = "</a><br><a href='?Page=$Page&Sess=".$gI->code1."&Var=".$gI->code2."&Remove=Yes' style='font-size:10pt;' class='btn-primary'>Remove</a>";
  ...
  $TheItemName = $TheItemName . "...";
          ...
          <td valign='top' align='center'>
            ...
            $echo1<img src='../Catalog/Dir/".$gI->File."'>
            <br />
              ...
              if($Page&&$Sess&&$Var&&$Wear)
              {
                ...
                else if($gi1 >= 1)
                {
                  ...
                  if($gi->code1 == $code1&&$gi->code2 = $code2)
                  {
                    ...
                    header("Location: character.aspx?Page=$Page");
  ...
  $TheItemName = $TheItemName . "...";
    ...
    <td style='width:400px;border-right:0;border-left:1px solid lightgrey;' valign='top' class='divider-right'>
      <h2>
        My Inventory
      </h2>
      <div id='aB'>
...
if ($Items == 0) {
echo "Looks like you don't have any items! Why not look for some in the <a href='../Catalog/Store.aspx'>store</a> or <a href='../Catalog/UserStore.aspx'>user store</a>?";
}
...
$Type = $gI->Type;
  ...
  if($myU->$type == $gI->File)
  {
    ...
    $echo = "</a><a href='?Page=$Page&Sess=".$gI->code1."&Var=".$gI->code2."&Remove=Yes' style='font-size:10pt;' class='btn-primary'>Remove</a>";
    $echo1 = "</a><a href='?Page=$Page&Sess=".$gI->code1."&Var=".$gI->code2."&Remove=Yes' style='font-size:10pt;'>";
  
  }
  else
  {
  
    $echo = "<a href='?Page=$Page&Sess=".$gI->code1."&Var=".$gI->code2."&Wear=Yes' style='font-size:10pt;' class='btn-primary'>Wear</a>";
    $echo1 = "<a href='?Page=$Page&Sess=".$gI->code1."&Var=".$gI->code2."&Wear=Yes' style='font-size:10pt;'>";
  ...
  echo "<td align='center' valign='top'>$echo1<img src='/Catalog/Dir/".$gI->File."' width='100' height='200'></a><a href='".$Link."?ID=".$gI->ItemID."' border='0' title='".$gN->Name."'><br />".$TheItemName."<br><font size='2'>
  ";
  echo "
  ";
...
if ($Page > 1) {
echo '<a href="character.aspx?Page='.($Page-1).'">Previous</a> - ';
}
echo '   Page '.$Page.' of '.(ceil($num / $Setting["PerPage"]));
if ($Page < ($amount)) {
echo ' - <a href="character.aspx?Page='.($Page+1).'">Next</a>';
}
