...
class AdminController extends BaseController {
	...
	public function DoConfig()
	{
		...
		$rule  =  array(
				...
				'userstore'  			=> 'required|min:3',
				'avatarwidth'  			=> 'min:1',
				'avatarheight'  		=> 'min:1',
		        'description'			=> 'required|min:1',
		        'currency_1'  			=> 'required|min:1',
		        'sitedomain'			=> 'required|min:2'
		);
		$messages = array(
		    	'min'	         		=> 'The :attribute must be at least :min characters long',
		...
		if ($validator->fails())
		{
				...
				$config->userstore		= Input::get('userstore');
				$config->avatarwidth	= Input::get('avatarwidth');
				$config->avatarheight	= Input::get('avatarheight');
