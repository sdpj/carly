...
include($_SERVER['DOCUMENT_ROOT']."/Header.php");
  ...
  $gsold = mysql_num_rows($getSold);
        ...
        $gCo = mysql_fetch_object($getConfig);
  if ($gI->itemDeleted == "1") {
  ...
  <table width='95%'>
    ...
    overflow: hidden !important;
                ...
                <div style='border: 1px solid #bbb;border-radius:5px;width:100px;height:200px;'>Item Renders Are WIP
                  <!--<iframe src='http://bopimotest.ml/?t=http://rn1host.ml:53640/Store/Dir/".$gI->File."' width='100' height='200' class='wrap'></iframe>-->
                </div>
              </td>
              <td width='500' valign='top'>
                <table>
                  <tr>
                    <td valign='top'><a href='/User.php?Profile=".$gC->Username."' border='0' style='color:black;'>
                      <center><b>Creator:</b><br>
                      ";
                      if($gCo->Avatars == "3D"){
echo"<img src='/Avatars/".$gC->Avatar3D."' width='256' height='256'>";}elseif($gCo->Avatars == "2D"){
echo"<img src='/Avatar2D.php?ID=".$gI->CreatorID."'>";
};
                      echo "<br>
                      <b>".$gC->Username."</b>
                      </a>
                    ...
                    <td valign='top' align='left' width='300'>
                      ...
                      <a href='/Store/UserConfigureItem.php?ID=".$ID."' style='color:black;'><b>Configure Item</b></a>
                      ";
                      }
                      echo "
                    </td>
          ...
          ";
            ...
            while ($gC = mysql_fetch_object($getComments)) {
              ...
              <table width='95%'>
                ...
                $width = 100;
                echo "
            <!--<div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Background . ");'>
            <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Body . ");'>
              <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Eyes . ");'>
                <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Mouth . ");'>
                  <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Hair . ");'>
                    <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Bottom . ");'>
                      <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Top . ");'>
                        <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Hat . ");'>
                          <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Shoes . ");'>
                            <div style='width: ".$width."px; height: ".$height."px; z-index: 3;  background-image: url(/Store/Dir/" . $gP->Accessory . ");'>-->
                  <img src='/Avatars/".$gP->Avatar3D."' width='170' height='170'>
