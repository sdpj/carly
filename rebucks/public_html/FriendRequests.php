...
if ($_GET['accept']){
	...
	if ($check != 0){
		...
		mysql_query("INSERT INTO `messages` (`fromid`, `toid`, `subject`, `body`) VALUES ('1', '$with', 'Your friend request was accepted.', '$user[Username] has accepted your friend request!')");
...
if ($_GET['decline']){
	...
	if ($check != 0){
		...
		mysql_query("INSERT INTO `messages` (`fromid`, `toid`, `subject`, `body`) VALUES ('1', '$with', 'Your friend request was declined.', '$user[Username] has declined your friend request!')");
