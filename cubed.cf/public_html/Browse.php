...
<table class="table" cellspacing="0" cellpadding="0" border="0" id="_ctl0_cphRoblox_gvPlacesBrowsed" style="border:0px;">
<tbody>
<tr class="table-headerr" style="background-color: hsla(0,0%,96.5%,.125);border:0px;">
...
<th class="" style="width:255px;border-right: 0px solid #cccccc">Role</th>
</tr>
<?php
                    if(!isset($_GET['page'])) {
                        $page = 1;
...
echo '
<tr class="table-item">
<td style="border-left: 1px solid hsla(0,0%,96.5%,.125);"><a class="roblox-avatar-image" data-user-id="' . $row['id'] . '" data-image-size="custom" data-image-size-x="64" data-image-size-y="64" href="/User.aspx?id=' . $row['id'] . '"><div style="position: relative;"><a href="/User.aspx?id=' . $row['id'] . '"><img title="' . $username . '" alt="' . $username . '" border="0" height="64" width="64" src="/get_avatar?id=' . $row['id'] . '"></a></td>
