...
<head>
    ...
    <!-- MachineID: WEB397 -->
    <title><?=$sitename;?> - Play and Create</title>
	<link rel="canonical" href="http://xsscape.ml" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="author" content="<?=$sitename;?>"/>
<meta name="description" content="<?=$sitename;?> is a private server for the game ROBLOX. <?=$sitename;?> utilizes legacy clients and a classic site. We are not affliated with ROBLOX Corporation."/>
...
<meta name="google-site-verification" content="KjufnQUaDv5nXJogvDMey4G-Kb7ceUVxTdzcMaP9pCY"/>
    ...
    <meta property="og:url" content="http://www.xsscape.ml/"/>
    <meta property="og:description" content="<?=$sitename;?> is a private server for the game ROBLOX. <?=$sitename;?> utilizes legacy clients and a classic site. We are not affliated with ROBLOX Corporation."/>
    ...
    <meta name="twitter:description" content="<?=$sitename;?> is a private server for the game ROBLOX. <?=$sitename;?> utilizes legacy clients and a classic site. We are not affliated with ROBLOX Corporation.">
    ...
    <div class="container">
        <div class="row">
            <div class="navbar-header col-md-6">
                ...
                <div class="navbar-brand hidden-xs"><img alt="<?=$sitename;?> Logo" class="robloxLogo" src="/img/roblox_logo.svg"/></div>
...
<a href="/Login" class="btn-primary-md" style="margin-top: 7px; position: fixed; right: 2%;">Log In</a>
    </div>
        </div>
    </div>
</div>
                ...
                <div class="col-xs-12 col-md-6">
                    <div id="MainLogo" class="text-right">
                        <div id="LogoAndSlogan" class="text-center">
                            <img id="MainLogoImage" title="<?=$sitename;?>" class="center-block img-responsive" src="/img/roblox_logo.svg"/>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    document.getElementById("counter").innerHTML = "Launching soon!";
       ...
       <a type="button" tabindex="9" class="btn-primary-md signup-submit-button" href="/Register">Sign Up Now!</a>
       </div></span>
            <noscript>
        ...
        <div class="col-md-12 inner-full-height-section">
            <div class="row" id="InnerWhatsRobloxContainer1">
                <div id="WhatIsRobloxTextBg" class="col-sm-5 col-sm-offset-6 col-xs-8 col-xs-offset-2">
                    <h1 class="text-center">What is <?=$sitename;?>?</h1>
                    <p class="lead text-justify">
                        <?=$sitename;?> is the best place to imagine with friends. With the largest user-generated online gaming platform, and over 15 million games created by users, <?=$sitename;?> is the #1 gaming site for kids and teens. Every day, virtual explorers come to <?=$sitename;?> to create adventures, play games, role play, and much more with their friends in an immersive 3D environment.
                    </p>
                </div>
            </div>
