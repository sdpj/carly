...
error_reporting(0);
	...
	if(!$AdminSession && $_SERVER['PHP_SELF'] != '/auth.admin/login.php'){
		header("Location: /auth.admin/login.aspx");
		die();
	}
	
	echo'<LINK href="/auth.admin/style/style.css" rel="stylesheet" type="text/css"><LINK href="/Base/Style/Main.css" rel="stylesheet" type="text/css">';
	
	echo"<title>Avatar-Universe | Administration</title>
	<div class='site-header'>
		<div id='navigation-container'>
			<a href='/'>
				<img src='/Images/world2build.png' width='190' height='35' style='margin-bottom:2px;margin-right:15px;vertical-align:bottom;'>
			</a>
		</div>
	</div>
	...
	<center>
		<a href='../index.aspx?admin=return'>
			<img src='/auth.admin/img/adminpanel.png'>
		</a>
		<br />
