...
<style type="text/css">
  ...
  .finoob {
    color: #fff !important;
    background-color: rgb(40, 182, 44) !important;
    border-color: rgb(35, 161, 39) !important;
    border-bottom: 3px;
...
<div style="height:23px;border:0px solid #a7a7a7;padding:0px;margin-right:6px;float:left;position:relative">
<!--[if IE7]>
...
<a id="submitSearchButton" href="#" class="btn-control btn-control-large top-level finoob">Search</a>
</div>
</div>
...
<li><a href="#creator=1" class="creatorFilter" data-creatorid="1"><?php echo $name;?></a></li>

<li><input id="creatorTextbox" name="name" type="text" value="Name" class="Watermark translate text-box text-box-small"> <a href="#" id="submitCreatorButton" class="btn-control btn-control-small finoob" style="padding-bottom: 19px; padding-left: 9px; padding-right: 26px;">Go</a></li>
</ul>
...
<li><a href="#price=1" class="priceFilter" data-currencytype="1">Posties</a></li>
...
A limited supply originally sold by <?php echo $name;?>. Each unit is labeled with a serial number. Once sold out, owners can re-sell them to other users.
</div>
</div>
</div> </div>
...
<span class="tickets" style="color:#fe00b0;padding:0px!important;" data-se="item-priceintickets"><i class="material-icons left" style="font-size:14px;margin-right:6px;margin-top:-1px;">monetization_on</i><? echo " $gI->price"; ?></span>
</div>
