<?
    @mysql_connect("mysql.ct8.pl","m27001_social","Sg090228");
    mysql_select_db("m27001_social");
...
$Hat = "noynac.obj";
          ...
          // HEAD
          THREE.ImageUtils.crossOrigin = "";
          var texture =  THREE.ImageUtils.loadTexture("/Store/Dir/<?if (empty($Mouth)) {
$Mouth = "defaultface.png";
}; echo"$Mouth";?>");
          var texturetwo =  THREE.ImageUtils.loadTexture("https://dijf55il5e0d1.cloudfront.net/images/na/5/0/2/50230_1000.jpg");
          
          var textureHead = THREE.ImageUtils.loadTexture("/Store/Dir/yellow.png");
          var textureLeftArm = THREE.ImageUtils.loadTexture("/Store/Dir/yellow.png");
          var textureTorso = THREE.ImageUtils.loadTexture("/Store/Dir/noobtemp.png");
          var textureRightArm = THREE.ImageUtils.loadTexture("/Store/Dir/yellow.png");
          var textureLeftLeg = THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
          var textureRightLeg = THREE.ImageUtils.loadTexture("/Store/Dir/green.png");
          ...
          face.position.z = 0.22;
              ...
              // T SHIRT
              var texture =  THREE.ImageUtils.loadTexture("/Store/Dir/<?if (empty($TShirt)) {
$TShirt = "thingTransparent.png";
              ...
              var texture = THREE.ImageUtils.loadTexture("/Store/Dir/<?if (empty($Top)) {
$Top = "noobtemp.png";
}; echo"$Top";?>");
              texture.flipY = false;
              texture.flipX = false;
              ...
              var texture = THREE.ImageUtils.loadTexture("/Store/Dir/<?if (empty($Bottom)) {
$Bottom = "green.png";
}; echo"$Bottom";?>");
              texture.flipY = false;
              texture.flipX = false;
