...
if(!empty($_GET['ip']) AND !empty($_GET['port']) AND !empty($_GET['auth']))
{
    $ip = $_GET['ip'];
    $port = $_GET['port'];
    $name = $usr['username'];
...
game:GetService("InsertService"):SetBaseCategoryUrl("http://yrk.ct8.pl/Game/Tools/InsertAsset.php?nsets=10&type=base")
game:GetService("InsertService"):SetUserCategoryUrl("http://yrk.ct8.pl/Game/Tools/InsertAsset.php?nsets=20&type=user&userid=%d")
game:GetService("InsertService"):SetCollectionUrl("http://yrk.ct8.pl/Game/Tools/InsertAsset.php?sid=%d")
game:GetService("InsertService"):SetAssetUrl("http://yrk.ct8.pl/Asset/?id=%d")
game:GetService("InsertService"):SetAssetVersionUrl("http://yrk.ct8.pl/Asset/?assetversionid=%d")
