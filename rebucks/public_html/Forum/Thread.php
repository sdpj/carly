...
if ($_GET['id']){
    ...
    <center><a href="index.php">Avatar Central Forums</a> &rarr; <a href="Forum.php?id=<?php print_r($thread['inid']); ?>"><?php print_r($inforum['name']); ?></a> &rarr; <a href="#"><?php print_r($thread['subject']); ?></a></center>
<br /><br />
...
<?php print_r($posterarray['Signature']); ?></div></center>
</td>
</tr>
</table><br>
...
<br /><br /><br><br><br>
<center><?php print_r($author['Signature']); ?></div></center>
<?php if ($logged == true){
	if ($user['powerCM'] != '0' || $user['powerForumMod'] != '0' || $user['powerHeadMod'] != '0'){
		?>
