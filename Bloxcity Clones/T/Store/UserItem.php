            ...
            <tr>
              <td align='center' width='100' valign='top'>
                ...
                <div style='border: 1px solid #bbb;border-radius:5px;width:100px;height:200px;'>
                  <iframe src='http://bopimotest.ml/?s=".$gI->File."' width='100' height='200'></iframe>
                </div>
              </td>
                ...
                <table>
                  <tr>
                    <td valign='top'><a href='/User.php?Profile=".$gC->Username."' border='0' style='color:black;'>
                      ...
                      ";
                      if($gCo->Avatars == "3D"){
echo"<iframe src='/GetCharacter3D?ID=".$gI->CreatorID."' width='430' height='350' scrolling='no' frameBorder='0'></iframe>";}elseif($gCo->Avatars == "2D"){
