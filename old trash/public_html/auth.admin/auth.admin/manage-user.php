							...
							<table cellspacing='0' cellpadding='0'>
								<tr>
									<td style='text-align:center;'>
										<img src='http://avatar-gamer.ga/Avatar.aspx?ID=<?echo"".$gU->ID."";?>'>
									</td>
...
<?
					...
					<div class='GenericModalBody'>
						<div class='TopBody' style='padding:10px;text-align:center;'>
							<div class='Message'>
								...
								<img src='http://avatar-gamer.ga/auth.admin/img/Oops.png' height='64'>
							</div>
						</div>
						<div class='ConfirmationContainer'>
							<center>
								<a href='http://avatar-gamer.ga/auth.admin/manage-user.aspx?ID=".$ID."' class='btn-forgotten'>Cancel</a>
							</center>
						</div>
					</div>   
				</div>
						...
						<div class='GenericModalBody'>
							<div class='TopBody' style='padding:10px;text-align:center;'>
								<div class='Message'>
									...
									<img src='http://avatar-gamer.ga/auth.admin/img/Yay.png' height='64'>
								</div>
							</div>
							<div class='ConfirmationContainer'>
								<center>
									<a href='http://avatar-gamer.ga/auth.admin/manage-user.aspx?ID=".$ID."' class='btn-forgotten'>Close</a>
								</center>
							</div>
						</div>   
					</div>
	...
	if($Ban){
		header("Location: http://avatar-gamer.ga/auth.admin/mod-user.aspx?ID=".$ID."");
		die();
	}
	if($IPBan){
		echo"
