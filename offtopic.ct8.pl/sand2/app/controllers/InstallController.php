...
class InstallController extends BaseController {
	...
	public function DoWelcome()
	{
		...
		$messages 	= array(
			'license-key.required'  => 'You must enter a license key',
	    	'license-key.regex'	    => 'You must enter your license key in the format XXXXX-XXXXX-XXXXX-XXXXX-XXXXX'
		);
		...
		if ($validator->fails())
		{
			...
			if ($output['valid'] == 0 || $output['domain'] != $this->getDomain())
			{
